...
export function Sidebar({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex min-h-screen bg-gradient-to-br from-gray-900 via-gray-900 to-gray-950 p-4">
            {/* Sidebar */}
            <div
                className={`sticky top-4 flex-shrink-0 rounded-2xl bg-gradient-to-b from-gray-800 via-gray-800 to-gray-900 border border-gray-700 shadow-2xl transition-all duration-300 ${sidebarExpanded ? 'w-56' : 'w-20'
                    }`}
